...
let centro1 = nuevoCentro("Volcan de pacaya")
let centro2 = nuevoCentro("Rio dulce")
let centro3 = nuevoCentro("Laguna Luchoa")
let centro4 = nuevoCentro("Playa Blanca")
let centro5 = nuevoCentro("Antigua Guatemala")
let centro6 = nuevoCentro("Lago de Atitlan")
...
print("Persona nombre: ", p1.nombre, ", edad: ", p1.edad, ", carroTipo: ", p1.carro.tipo, ", nuevos numeros: ", nums2.datos)
