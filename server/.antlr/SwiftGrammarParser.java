...
public class SwiftGrammarParser extends Parser {
	...
	public static final int
		...
		RULE_forstmt = 8, RULE_breakstmt = 9, RULE_continuestmt = 10, RULE_fnstmt = 11, 
		RULE_listParamsFunc = 12, RULE_parametro = 13, RULE_callExp = 14, RULE_callFunction = 15, 
		RULE_listParamsCall = 16, RULE_types = 17, RULE_expr = 18, RULE_listParams = 19, 
		RULE_listAccessArray = 20, RULE_listArray = 21, RULE_exprComa = 22;
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 274899982528L) != 0) );
	...
	public final FnstmtContext fnstmt() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_fnstmt);
		try {
			setState(230);
			_errHandler.sync(this);
	...
	private ListParamsFuncContext listParamsFunc(int _p) throws RecognitionException {
		...
		int _startState = 24;
		enterRecursionRule(_localctx, 24, RULE_listParamsFunc, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	private ListAccessArrayContext listAccessArray(int _p) throws RecognitionException {
		...
		int _startState = 40;
		enterRecursionRule(_localctx, 40, RULE_listAccessArray, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	private ExprComaContext exprComa(int _p) throws RecognitionException {
		...
		int _startState = 44;
		enterRecursionRule(_localctx, 44, RULE_exprComa, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
